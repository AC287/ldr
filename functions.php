...
function ldr_script_enqueue() {
  ...
  wp_enqueue_style('customstyle',get_template_directory_uri().'/css/ldr.css', array(), '1.0.17', 'all');
  ...
  wp_enqueue_script('customjs',get_template_directory_uri().'/js/ldr.js', array('jquery'), '1.0.05', true);
